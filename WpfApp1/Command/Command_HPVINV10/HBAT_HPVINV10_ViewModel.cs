...
{
    public class HBAT_HPVINV10_ViewModel:BaseViewModel
    {
        //指令
        ...
        public HBAT_HPVINV10_ViewModel(ManualResetEventSlim pauseEvent, SemaphoreSlim semaphore, Action<string> addLog, Action<string> updateState)
        {
        ...
        public string BatCurr
        {
            ...
            set
            {
                _BatCurr = Tools.RemoveLeadingZeros(value);
                this.RaiseProperChanged(nameof(BatCurr));
            }
        }
        ...
        #region 电池功率
        private string _BatPwr;
        public string BatPwr
        {
            get { return _BatPwr; }
            set
            {
                _BatPwr = Tools.RemoveLeadingZeros(value);
                this.RaiseProperChanged(nameof(BatPwr));
            }
        }
        #endregion
        ...
        private void ReceiveException(string exceptionDescription)
        {
            ...
            //电池电流
            BatCurr = exceptionDescription;
            //电池功率
            BatPwr = exceptionDescription;
        }
