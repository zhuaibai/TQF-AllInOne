...
namespace WpfApp1.ViewModels
{
    public class DataRecrodingVM : BaseViewModel
    {
        ...
        #region HPVINV09的保存命令和配置
        private ICommand _HPVINV09SaveCommand;
        public ICommand HPVINV09SaveCommand
        {
            get
            {
                return _HPVINV09SaveCommand ?? (_HPVINV09SaveCommand = new RelayCommand(() => StartSavingWithConfig(GetHPVINV09Config())));
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        private static DeviceExcelConfig GetHPVINV09Config()
        {
            var config = new DeviceExcelConfig
            {
                DeviceName = "HPVINV09",
