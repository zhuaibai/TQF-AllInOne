...
namespace WpfApp1.Models
{
    public class Common_Data
    {
        ...
        public string? RectificationTemp { get; set; }//整流温度
        ...
        public string? Fan2Enable { get; set; }//风扇2使能
        ...
        public string? ChargeCurrentLimitFlag { get; set; } //充电电流限制标志

        public string? ACCouplingCurrentLimitFlag { get; set; } //市电耦合电流限制标志

        public string? MPPTCurrentLimitFlag { get; set; } //MPPT限制标志

        public string? BatteryDischargeCurrentLimitFlag { get; set; } //电池放电限流标志

        public string? BPhotovoltaicVoltageStatus { get; set; } //B路PV电压状态

        public string? BMPPTStatus { get; set; } //B路MPPT状态

        public string? CurrentSecondOutputRemoteControlStatus { get; set; } //当前第二输出远程控制状态

        public string? CurrentALLOutputRemoteControlStatus { get; set; } //当前所有输出远程控制状态
        #endregion
        ...
        public string? BatPwr { get; set; }//电池功率
