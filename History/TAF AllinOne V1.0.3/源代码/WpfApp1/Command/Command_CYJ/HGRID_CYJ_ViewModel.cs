...
{
    public class HGRID_CYJ_ViewModel : BaseViewModel
    {
        //指令
        ...
        public HGRID_CYJ_ViewModel(ManualResetEventSlim pauseEvent, SemaphoreSlim semaphore, Action<string> addLog, Action<string> _updateState)
        {
